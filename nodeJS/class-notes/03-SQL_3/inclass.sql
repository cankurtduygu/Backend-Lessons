...
-- En pahalı 10 parçayı ve bunların albüm/sanatçı bilgilerini listeleyin

-- 2010 yılında kesilen faturaların aylık dağılımını gösterin

-- Hangi müzik türünde kaç adet parça olduğunu bulun

-- Ortalama parça süresinden uzun olan parçaları listeleyin