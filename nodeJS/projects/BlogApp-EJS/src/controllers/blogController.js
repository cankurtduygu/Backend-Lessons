...
module.exports.post = {
  list: async (req, res) => {
    ...
    // { field: { $regex: 'value', $options: 'i' }} // this is how mongodb expect search
    // { title: 'test 4' }
    ...
    // search['title'] = { $regex: 'test 4', $options: 'i'}}
  ...
  create: async (req, res) => {
    ...
    // add loggedin user id for creation of blog post.
    req.body.userId = _id;
  ...
  update: async (req, res) => {
    ...
    // todo check if user wants to update someone else blog.
  ...
  delete: async (req, res) => {
    ...
    // todo check if user wants to delete someone else blog.
